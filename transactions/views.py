...
from transactions.constants import DEPOSIT, WITHDRAWAL,LOAN, LOAN_PAID, TRANSFER, TRANSFER_RECEIVED
...
def send_transaction_email(user, amount, subject, template, from_account_no, to_account_no):
...
class TransferMoneyView(FormView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            f'Successfully transferred ${amount:.2f} to account {to_account.account_no}'
        )
        ...
        return redirect(reverse('transaction_report'))
